...
<div class="flex justify-center">
    ...
    :class="store.myAmount.total > -1 ? 'bg-green-600' : 'bg-red-600'">
        <div class="flex flex-col justify-center pl-5 sm:pl-10">
            <p class="text-lg" 
            :class="store.myAmount.total > -1 ? 'text-green-200' : 'text-red-200'">
        ...
        <div class="flex flex-col items-end gap-9 p-6">
            ...
            <p class="text-rg" :class="store.myAmount.total > -1 ? 'text-green-200' : 'text-red-200'">{{ store.groupTransaction.filter(t => t.paid === false).length }} spese da saldare</p>
        </div>
    </div>
</div>

...
<div class="flex justify-center">
    ...
    :class="store.myAmount > -1 ? 'bg-green-600' : 'bg-red-600'">
        <div class="flex flex-col justify-center pl-5 sm:pl-10">
            ...
            <p class="text-rg pt-5" :class="store.myAmount > -1 ? 'text-green-200' : 'text-red-200'">{{ store.groupData.length }} gruppi attivi</p>
        </div>
        <div class="flex flex-col items-end gap-9 p-6">
            ...
            <p class="text-rg" :class="store.myAmount > -1 ? 'text-green-200' : 'text-red-200'">3 gruppi Attivi</p>
        </div>
    </div>
</div>
